...
type: rule
title: Do you use Google Tag Manager (GTM) to manage your tags?
...
Multiple marketing tools can be added to a website using Google Tag Manager.
